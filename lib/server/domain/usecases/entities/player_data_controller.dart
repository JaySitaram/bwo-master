...
class PlayerDataController {
      ...
      if (name == _player.name) {
        ...
        ServerUtils.addEntityIfNotExist(
            ...
            (Player(newX, newY, _map, name, playerId, null,
                spriteFolder: sprite, isMine: false) as Entity));
      }
    });
  ...
  void onAddPlayer(dynamic data) {
    ...
    ServerUtils.addEntityIfNotExist(_map, (e as Entity));
  ...
  void onMove(dynamic data) {
    ...
    ServerUtils.addEntityIfNotExist(_map, (p as Entity), updateIfExist: true);
  ...
  void onPlayerAttackEnemy(dynamic data) {
    ...
    if (enemyEntity is Enemy && playerEntity is Player) {
      (playerEntity as Player).currentSprite = (playerEntity as Player).attackSprites;
