...
class MapController {
  ...
  void _addTrees(int x, int y, int z, int tileSize) {
    if (x % 6 == 0 && y % 6 == 0) {
      ...
      if (treeHeight > 165) {
        ...
        if (y % 5 == 0) {
          entityList.add(Tree(this, x, y, tileSize, "tree04") as Entity);
        } else if (y % 6 == 0) {
          entityList.add(Tree(this, x, y, tileSize, "tree02") as Entity);
        } else if (y % 7 == 0) {
          entityList.add(Tree(this, x, y, tileSize, "tree03") as Entity);
        } else {
          entityList.add(Tree(this, x, y, tileSize, "tree01") as Entity);
        }
      }
    }
  }
  ...
  void addPlayerRef(Player player) {
    this.player = player;
    entityList.add(player as Entity);
  }
